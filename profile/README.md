# JQI Nanophotonics — Student & Postdoc Onboarding
...
New to the group? Read through `ScientificGraphicDesign` first — it covers the tools (Illustrator, Blender, plotting) you'll use across almost every project. Then check `ScientificDataManagement` before you start collecting data on a new project, so you set things up right from day one.
## Contributing
